...
(function () {
  ...
  const events = [
    { name: 'Марія, Київ',      msg: 'щойно замовила сандалі 🖤' },
...
const STATIC_REVIEWS = [
  { id: 1, name: 'Марина К., Київ', rating: 5, text: 'Сандалі дуже зручні, взяла 38-й і сіли нормально. Носила весь день по місту, нічого не натерло, ремінець тримає добре.', date: '2026-05-04', deletable: false },
  { id: 2, name: 'olia_99, Харків', rating: 5, text: 'чорні реально під усе. брала під сукню і під джинси, виглядають акуратно. підошва м’яка, не як дешеві тапки)', date: '2026-05-03', deletable: false },
  { id: 3, name: 'Світлана, Одеса', rating: 5, text: 'Для моря і прогулянок супер. Перфорація спереду норм, нога не париться. Оплатила після примірки на Новій Пошті.', date: '2026-05-02', deletable: false },
  { id: 4, name: 'Ірина, Дніпро', rating: 5, text: 'Переживала за ремінець, бо часто натирає п’яту. Тут м’яко, регулюється, можна підтягнути під себе. Розмір 39 підійшов.', date: '2026-05-01', deletable: false },
  { id: 5, name: 'Наталя, Львів', rating: 4, text: 'Якість хороша за цю ціну. Посилка йшла 5 днів, але сандалі сподобались. На широкій стопі теж ок.', date: '2026-04-30', deletable: false },
  { id: 6, name: 'Вікторія, Суми', rating: 5, text: 'Ношу вже тиждень майже щодня. Платформа м’яка, стопа не втомлюється. Виглядають дорожче ніж на фото.', date: '2026-04-29', deletable: false },
  { id: 7, name: 'Анна Б., Запоріжжя', rating: 5, text: 'класні чорні сандалі, саме те на літо. не слизькі, ремінець липучка тримає. забрала без передоплати.', date: '2026-04-28', deletable: false },
  ...
  { id: 15, name: 'Аліна, Кропивницький', rating: 4, text: 'Сандалі стильні, легкі, колір універсальний. Трохи довго відповідали в чаті, але замовлення оформили нормально.', date: '2026-04-20', deletable: false },
]
